...
class Load:
    ...
    def _create_node_model(self):
        props_list = list(
            filter(lambda o: o["slug"] in self._props_list, self._record_props)
        )

        props_dict = {"id": self._id}
    ...
    def _create_node_others(self):
        relationships_list = list(
            filter(lambda o: o["slug"] not in self._props_list, self._record_props)
        )
