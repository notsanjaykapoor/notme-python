...
class PublishGeoChanged:
    """publish entity geo changed messages for the specified watch and entity list"""
    ...
    def call(self) -> Struct:
        ...
        for watch in self._watches:
            for entity_id in self._entity_ids:
                message = models.Entity.message_geo_changed_cls(str(entity_id))
